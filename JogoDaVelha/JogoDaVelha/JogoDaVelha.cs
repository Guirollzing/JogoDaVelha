...
namespace JogoDaVelha
{
    class JogoDaVelha
    {
        ...
        private char vez;
        private int quatidadePreenchida;
        ...
        {
            Console.WriteLine($"Agora é a vez de {vez}, entre com uma posição de 1 a 9 que esteja na tabela.");
            ...
            {
                Console.WriteLine("o Campo é invalido, por favor digite um número de 1 a 9 que esteja disponivel na tabela.");
